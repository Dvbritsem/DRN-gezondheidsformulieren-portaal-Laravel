        ...
        <div class="inline-flex flex-1 w-full flex-wrap justify-evenly">
            <div class="flex-grow md:max-w-input mt-4 mx-2">
                ...
                <div>
                    ...
                    <x-input id="allergieën" class="block mt-1 w-full" type="text" name="allergieën" placeholder="Nee" />
                </div>
                <!-- Medicijnen gebruik -->
                <div class="mt-4">
                    <x-label for="medicijnen_gebruik" :value="__('Gebruikt uw kind medicijnen? Zo ja, welke? (Wanneer en welke dosis?)')" />
                    <x-input id="medicijnen_gebruik" class="block mt-1 w-full" type="text" name="medicijnen_gebruik" placeholder="Nee" />
                </div>
                <!-- Medicijnen niet -->
                <div class="mt-4">
                    <x-label for="medicijnen_niet" :value="__('Zijn er medicijnen die Uw kind niet mag gebruiken? Zo ja, welke?')" />
                    <x-input id="medicijnen_niet" class="block mt-1 w-full" type="text" name="medicijnen_niet" placeholder="Nee" />
                </div>
            </div>
            <div class="flex-grow md:max-w-input mt-4 mx-2">
                <!-- Dieet -->
                <div>
                    ...
                    <x-input id="dieet" class="block mt-1 w-full" type="text" name="dieet" placeholder="Nee" />
                </div>
                <!-- Vaccinatie -->
                <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <x-input id="syndroom" class="block mt-1 w-full" type="text" name="syndroom" placeholder="Nee" />
                </div>
            </div>
        </div>
